...
if (isset($_SESSION['user'])) {
    ...
    $list_orders = $this->OrderModel->select_list_orders($user_id);
?>
    ...
    foreach ($list_orders as $value) {
        extract($value);
        $list_products_buyed = $this->OrderModel->select_orderdetails_and_products($order_id);
        //Trang thái đơn hàng
        ...
        $date_formated = $this->BaseModel->date_format($date, '');
    ?>
