        ...
        <div class="col-sm-8 col-xl-5">
            <form action="" method="post">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">
                        <a href="danh-sach-bai-viet" class="link-hover">Bài viết</a> /
                        <a href="danh-muc-bai-viet" class="link-not-hover">Chuyên mục</a>
                        / Thêm chuyên mục
                    </h6>
                    <?= $html_alert ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="update-category-bai-viet&id=<?= $value['id'] ?>" class="btn-sm btn-secondary">Sửa</a>
                                        <a href="danh-muc-bai-viet&xoa=<?= $value['id'] ?>&qty_post=<?= $value['post_count'] ?>" class="btn-sm btn-danger">Xóa</a>
                                    </td>
                                </tr>
                            <?php
                            }
