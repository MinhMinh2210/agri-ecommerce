    ...
    <form class="row g-4" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="col-sm-12 col-xl-3">
            <div class="bg-light rounded h-100 p-4">
                ...
                <h6 class="mb-4">
                    <input name="update_product" type="submit" value="Cập nhật" class="btn btn-custom text-success">
                    <a href="index.php?quanli=thung-rac-san-pham&xoatam=<?= $product_id ?>" onclick="return confirmDeletionTemp();" class="btn btn-custom text-success">Xóa tạm</a>
                </h6>
