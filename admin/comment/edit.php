...
<div class="container pt-4">
    <article class="card">
        ...
        <div class="card-body mt-2">
            <div class="row">
                <div class="col-lg-6">
                    <div class="bg-light rounded border" style="background-color: #ffff;">
                        <div class="p-4">
                            <?php
                            $trangThai = '';
                            if ($status == 0) {
                            ...
                            <form action="" method="post">
                                <div class="form-floating mb-3">
                                    <select name="status" class="form-select">
                                        ...
                                        foreach ($status_options as $option_value) {
                                            ...
                                            echo getStatusComment($option_value);
                                            echo "</option>";
                                        }
                                        ?>
                                    </select>
                                ...
                                <h6 class="mb-4">
                                    <input type="submit" name="update_status_comment" value="Cập nhật" class="btn btn-success">
                                    <a href="chi-tiet-binh-luan&id=<?= $comment_id ?>&xoa=<?= $comment_id ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa bình luận\nSau khi xóa sẽ không thể khôi phục!')" class="btn btn-danger">Xóa bình luận</a>
                                </h6>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="card mb-4 bg-light" style="background-color: #ffff;">
