...
<div class="container mt-5">
    <h5 class="text-center mb-4">Sản phẩm đã bán trong <?= $limit_day ?> ngày gần đây</h5>
    ...
    <canvas id="chart_order_by_date" class="mt-2" style="max-height: 500px; margin-right: 20px;"></canvas>
</div>
